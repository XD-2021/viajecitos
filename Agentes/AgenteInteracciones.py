...
from rdflib import Namespace, Graph, RDF, URIRef, Literal, XSD, FOAF
...
#Afegir datos de diferentes agentes
...
def agentbehavior1(cola):
    ...
    print ("Hola, m'he excecutat correctament ")
